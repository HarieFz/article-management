  ...
  const { mutate: handleAdd, isPending } = useMutation({
    mutationFn: async (data: z.infer<typeof schema>) => {
      ...
      if (typeof data.thumbnail === "string") {
        imageUrl = data.thumbnail; // sudah URL
      } else {
        const uploadResult = await UploadService.post(data.thumbnail); // File
        imageUrl = uploadResult.imageUrl;
      }

      const html = editor.getHTML();

      await ArticlesService.put({
        id: slug,
        title: data.title,
                      ...
                      <FormControl>
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            if (file) {
                              field.onChange(file); // set value ke react-hook-form
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    ...
                    {/* Tampilkan error jika konten kosong */}
